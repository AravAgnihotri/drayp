...
// TODO: fetch from Supabase saved_items table for the logged-in user
type MatchBadge = "new-match" | "review-fit"

const SAVED_ITEMS: { name: string; brand: string; fitScore: number; badge: MatchBadge }[] = [
                ...
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="mt-0.5 flex items-center gap-2">
                      ...
                      <span className="font-dm-mono text-xs font-medium text-[#0F6E56]">{item.fitScore}% fit</span>
                    </div>
                  </div>
                </div>
